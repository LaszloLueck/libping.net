...
{
    /// <summary>
    /// process an ICMP echo (RFC-792) command, also called ping. It does the job with both IPv4 and IPv6.
    /// </summary>
    ...
    /// <returns>returns a IcmpResponse object, or in case of an error, the exception</returns>
